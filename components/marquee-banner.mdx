---
title: 'MarqueeBanner: CSS Scrolling Text Announcement Banner'
sidebarTitle: 'MarqueeBanner'
description: 'MarqueeBanner renders a scrolling text strip using CSS animation, replicating the classic HTML marquee tag with a black background and lime-green text.'
---
