---
title: 'UnderConstruction Banner and Inline NEW Badge Components'
sidebarTitle: 'Badges'
description: 'UnderConstruction renders a blinking caution banner with hazard stripes. The inline NEW badge in FolderIcon flags recent entries with a red pixel label.'
---
