---
title: 'ForumQuote: phpBB 2.x Retro Forum Post React Component'
sidebarTitle: 'ForumQuote'
description: 'ForumQuote renders a phpBB 2-style forum post with a username sidebar, no-avatar placeholder, quoted content block, and a hardcoded binary signature.'
---
