---
title: 'SparkleCursor: Animated Mouse Trail Effect'
...
<Tip>
  **Change sparkle colors** — Edit the `P` array (exported as the color palette constant) inside the component file. Add as many hex values as you like; one is picked at random per sparkle.
</Tip>
