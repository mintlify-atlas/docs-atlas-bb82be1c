---
title: 'MoodEntry: LiveJournal-Style Diary Entry Component'
sidebarTitle: 'MoodEntry'
description: 'MoodEntry renders a LiveJournal-style diary card with post title, timestamp, current mood, now-playing music, and freeform React children as entry content.'
---
