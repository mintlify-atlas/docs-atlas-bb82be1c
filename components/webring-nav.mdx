---
title: 'WebringNav: 90s Webring Navigation Footer'
sidebarTitle: 'WebringNav'
description: 'WebringNav renders a classic webring navigation panel with Previous, Random, and Next Site links — a nostalgic nod to the era of hand-curated web directories.'
---
