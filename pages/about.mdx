---
title: "About Page: Personal Bio with Retro Stats Panel"
sidebarTitle: "About"
...
<ParamField path="(no props)" type="—">
  Internally tracks a `playing` boolean via `useState`. The track name (`Darude - Sandstorm.mp3 (128kbps)`) and elapsed time (`01:23`) are hard-coded in the component source. Edit `components/WinampPlayer.js` directly to change the displayed track or timestamp.
</ParamField>
